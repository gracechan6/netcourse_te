 ...
 */
public class AnnInfoAdapter extends BaseAdapter{

    class ViewHolder{
        /*public View unread;*/
        public TextView title,content;
    }
    private List<AnnInfoEntity> infoEntityList;
    private AnnInfoEntity entity;
    private ViewHolder viewHolder;
    private Context context;
    private LayoutInflater inflater;

    public AnnInfoAdapter(List<AnnInfoEntity> infoEntityList, Context context) {
